...
Step-by-step walkthroughs for provisioning and operating Money Honey. Run them in roughly the order below.

| Guide | When you need it |
|---|---|
| [Prerequisites](prerequisites.html) | Before you do anything else — Azure CLI, Terraform, kubectl, Helm versions, login. |
...
| [Key Vault secrets](kv-secrets.html) | Populate Anthropic + Cloudflare secrets that operators must supply. |
