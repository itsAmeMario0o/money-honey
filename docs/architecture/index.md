...
Three domains. Eight layers. Each page below covers one part of the model.
...
Full reference with diagrams and code examples: [`ARCHITECTURE.md`](https://github.com/itsAmeMario0o/money-honey/blob/main/ARCHITECTURE.md) in the repo.
