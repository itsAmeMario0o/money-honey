...
5. **Rollback** — if the fix made things worse
...
- **Capture timestamps.** Note the start/end of every change in your incident log — you'll need them for Splunk searches.
