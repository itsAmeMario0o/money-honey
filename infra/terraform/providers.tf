...
// helm provider 2.17 uses the block form for `kubernetes` — the
// attribute form is a 3.x-only feature. VSCode's language server
// may flag this as a false positive; trust `terraform validate`.
provider "helm" {
  kubernetes {
